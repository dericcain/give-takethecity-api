...
var _veeValidate = __webpack_require__(51);

var _veeValidate2 = _interopRequireDefault(_veeValidate);

var _vMask = __webpack_require__(50);
...
_vue2.default.component('donation-form', __webpack_require__(52));
...
var _navButtons = __webpack_require__(56);

var _navButtons2 = _interopRequireDefault(_navButtons);

var _amountInfo = __webpack_require__(53);

var _amountInfo2 = _interopRequireDefault(_amountInfo);

var _peronsalInfo = __webpack_require__(57);

var _peronsalInfo2 = _interopRequireDefault(_peronsalInfo);

var _creditCardInfo = __webpack_require__(55);

var _creditCardInfo2 = _interopRequireDefault(_creditCardInfo);

var _review = __webpack_require__(58);

var _review2 = _interopRequireDefault(_review);

var _confirmation = __webpack_require__(54);
...
exports.default = {
    ...
    components: {
        'nav-buttons': _navButtons2.default,
        'amount-info': _amountInfo2.default,
        'personal-info': _peronsalInfo2.default,
        'credit-card-info': _creditCardInfo2.default,
    ...
    methods: {
         ...
         * @return {*}
         */
        changeStep: function changeStep(stepNumber) {
         ...
         * @param value
         */
        updateDonationInformation: function updateDonationInformation(field, value) {
         ...
         */
        willCoverFees: function willCoverFees() {
         ...
         */
        updateRecurring: function updateRecurring() {
         ...
         * @param state
         */
        toggleValid: function toggleValid(state) {
            this.isValid = state;
        },
         ...
         */
        sendDataToServer: function sendDataToServer(status, response) {
            var _this = this;
            ...
            if (response.error) {
                ...
                _axios2.default.post('/', this.donation).then(function (response) {
                    ...
                    _this.donation.error = error.response.data.error;
                });
            }
        },
         ...
         */
        resizeEachStep: function resizeEachStep() {
            var _this2 = this;

            this.steps = document.getElementsByClassName('step');
            _.each(this.steps, function (step) {
                step.style.width = _this2.width + 'px';
            });
        },
         ...
         */
        resizeSliderWrapper: function resizeSliderWrapper() {
         ...
         */
        fireMobileEvents: function fireMobileEvents() {
            this.checkMobile();
            if (this.isMobile) {
                this.resizeEachStep();
         ...
         */
        watchForResizeEvent: function watchForResizeEvent() {
        ...
        getDesignations: function getDesignations() {
            ...
            _axios2.default.get('/designations').then(function (response) {
                return _this3.designations = response.data;
            }).catch(function (error) {
...
exports.default = {
    ...
    methods: {
         ...
         * @return {boolean}
         */
        isActive: function isActive(amount) {
...
exports.default = {
    ...
    computed: {
        name: function name() {
            return _.capitalize(this.donation.firstName);
        }
    }
};
...
exports.default = {
    ...
    methods: {
         ...
         */
        updateYearDropdown: function updateYearDropdown() {
         ...
         * @param event
         */
        updateCreditCard: function updateCreditCard(event) {
         ...
         */
        validateCreditCardInfo: function validateCreditCardInfo() {
            var _this = this;

            return this.$validator.validateAll('cc').then(function (response) {
                if (response) _this.$emit('toggleValid', true);
            }).catch(function (error) {
                return false;
            });
        }
...
exports.default = {
    ...
    methods: {
        ...
        move: function move() {
            ...
            if (this.isMobile) {
                var style = window.getComputedStyle(this.innerFormWrapper),
         ...
         * @return {Number}
         */
        parseCurrentPosition: function parseCurrentPosition(number) {
...
exports.default = {
    ...
    methods: {
         ...
         */
        toggleRecurring: function toggleRecurring() {
        ...
        validateFields: function validateFields() {
            ...
            return this.$validator.validateAll('personal-info').then(function (response) {
                if (response) _this.$emit('toggleValid', true);
            }).catch(function (error) {
                return false;
            });
         ...
         * @param event
         */
        updatePersonalInfo: function updatePersonalInfo(event) {
            this.$emit('update', event.target.id, event.target.value);
            this.validateFields();
        }
    }
...
exports.default = {
    ...
    computed: {
        ...
        address: function address() {
            return this.donation.address.split(' ').map(function (word) {
...
// module
exports.push([module.i, "\n#submitFormButton {\n  width: 100%;\n  margin-top: 24px;\n  display: -ms-flexbox;\n  display: flex;\n  min-width: 100%;\n  display: -webkit-box;\n  -webkit-box-pack: center;\n  -webkit-box-align: center;\n  text-align: center;\n}\n#submitFormButton span {\n  -ms-flex-pack: center;\n      justify-content: center;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -webkit-box-align: center;\n}\n#submitFormButton span img {\n  max-height: 26px;\n  max-width: 30px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.logo {\n  margin-bottom: 24px;\n}\n.error-notification {\n  width: 100%;\n  margin-top: 18px;\n  text-align: center;\n  background: #b40b00 !important;\n  font-weight: 400;\n  font-size: 16px;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.recurring-button {\n  display: -ms-flexbox;\n  display: flex;\n  min-width: 100%;\n  display: -webkit-box;\n  -webkit-box-pack: center;\n  -webkit-box-align: center;\n  text-align: center;\n}\n.recurring-button span {\n  -ms-flex-pack: center;\n      justify-content: center;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -webkit-box-align: center;\n}\n.recurring-button span i {\n  font-size: 14px;\n  margin-right: 6px;\n  color: #8f0900;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.recurring-button.active {\n  background: #8f0900;\n  color: #fff !important;\n}\n.recurring-button.active:hover {\n  background-color: #a10a00;\n}\n.recurring-button.active i {\n  color: #fff;\n}\n.fa-envelope {\n  color: #8f0900;\n  font-size: 40px;\n  margin-bottom: 18px;\n}\ntextarea {\n  min-height: 60px !important;\n  max-height: 120px !important;\n}\n", ""]);
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation-form.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] donation-form.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0ebe54bf", Component.options)
  } else {
    hotAPI.reload("data-v-0ebe54bf", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/amount-info.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] amount-info.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f6cc516", Component.options)
  } else {
    hotAPI.reload("data-v-3f6cc516", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/confirmation.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7ad15cb2", Component.options)
  } else {
    hotAPI.reload("data-v-7ad15cb2", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/credit-card-info.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] credit-card-info.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-72760474", Component.options)
  } else {
    hotAPI.reload("data-v-72760474", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/nav-buttons.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] nav-buttons.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-66c886ea", Component.options)
  } else {
    hotAPI.reload("data-v-66c886ea", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/peronsal-info.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] peronsal-info.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-571d4f4c", Component.options)
  } else {
    hotAPI.reload("data-v-571d4f4c", Component.options)
  }
})()}
...
Component.options.__file = "/Users/Deric/Sites/valet/give.takethecity/resources/assets/js/public/components/donation/review.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54beee15", Component.options)
  } else {
    hotAPI.reload("data-v-54beee15", Component.options)
  }
})()}
  ...
  return _c('form', {
    ...
    on: {
      "submit": function($event) {
        ...
        _vm.submitDonation($event)
      }
    }
  }, [_c('div', {
    class: _vm.sliderClass,
    attrs: {
      "id": "inner-form-wrapper"
    }
  }, [_c('amount-info', {
    attrs: {
      "isValid": _vm.isValid,
      "donation": _vm.donation
    },
    on: {
      "update": _vm.updateDonationInformation,
      "toggleValid": _vm.toggleValid,
      "willCoverFees": _vm.willCoverFees
    }
  }), _vm._v(" "), _c('personal-info', {
    attrs: {
      "isValid": _vm.isValid,
      "designations": _vm.designations,
      "donation": _vm.donation
    },
    on: {
      "update": _vm.updateDonationInformation,
      "updateRecurring": _vm.updateRecurring,
      "toggleValid": _vm.toggleValid
    }
  }), _vm._v(" "), _c('credit-card-info', {
    attrs: {
      "isValid": _vm.isValid,
      "donation": _vm.donation
    },
    ...
    on: {
      "submitDonation": _vm.submitDonation
    }
  }), _vm._v(" "), _c('confirmation', {
    attrs: {
      "donation": _vm.donation
    }
  })], 1), _vm._v(" "), _c('nav-buttons', {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    attrs: {
      ...
      "innerFormWrapper": _vm.innerFormWrapper,
      "isValid": _vm.isValid
    },
    on: {
      "toggleValid": _vm.toggleValid
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0ebe54bf", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "label"
  }, [_vm._v("How much would you like to give?")]), _vm._v(" "), _c('div', {
    staticClass: "columns is-multiline is-gapless is-mobile"
  }, [_c('div', {
    staticClass: "column is-half"
  }, [_c('button', {
    staticClass: "button give-button",
    class: [_vm.donation.amount == 2500 ? 'is-active' : ''],
    attrs: {
      "type": "button"
    },
    on: {
    ...
    staticClass: "button give-button",
    class: [_vm.donation.amount == 5000 ? 'is-active' : ''],
    attrs: {
      "type": "button"
    },
    on: {
    ...
    staticClass: "button give-button",
    class: [_vm.donation.amount == 10000 ? 'is-active' : ''],
    attrs: {
      "type": "button"
    },
    on: {
    ...
    staticClass: "button give-button",
    class: [_vm.donation.amount == 25000 ? 'is-active' : ''],
    attrs: {
      "type": "button"
    },
    on: {
    ...
    staticClass: "control amount has-icon"
  }, [_c('input', {
    directives: [{
      name: "validate",
      rawName: "v-validate"
  ...
  }), _vm._v(" "), _vm._m(1)])]), _vm._v(" "), (_vm.donation.amount != '0' || _vm.donation.amount != 0) ? _c('div', {
    staticClass: "column is-12",
    attrs: {
      "id": "cover-fees"
    }
  }, [_c('p', [_vm._v("I'd like to cover the $" + _vm._s(_vm.donation.fees / 100) + " processing fee so 100% of my donation goes to Take the City.")]), _vm._v(" "), _c('button', {
    staticClass: "button",
    class: [_vm.donation.willCoverFees == true ? 'is-success' : ''],
    attrs: {
      "type": "button"
    },
    on: {
      "click": _vm.willCoverFees
    }
  }, [_c('i', {
    staticClass: "fa fa-check",
    class: [_vm.donation.willCoverFees == true ? '' : 'is-hidden']
  }), _vm._v(" "), (!_vm.donation.willCoverFees) ? _c('span', [_vm._v("Click to cover fees!")]) : _vm._e(), _vm._v(" "), (_vm.donation.willCoverFees) ? _c('span', [_vm._v("Fees covered!")]) : _vm._e()])]) : _vm._e()])])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "top column"
  }, [_c('div', {
    staticClass: "column"
  }, [_c('img', {
    staticClass: "logo",
    ...
    staticClass: "has-text-centered title is-2"
  }, [_vm._v("Thanks for giving!")]), _vm._v(" "), _c('p', [_vm._v("We are honored the you want to partner with us to transform cities! Your gift will have a direct impact\n            on the lives of those who need to hear the hope of Christ. If you want to learn more about what we do,\n            "), _c('a', {
    attrs: {
      "href": "https://takethecity.com"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3f6cc516", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "has-text-centered title is-4"
  }, [_vm._v("Let's review everything!")]), _vm._v(" "), (_vm.donation.recurring) ? _c('div', [_c('p', [_vm._v("You're gift will be a monthly recurring gift in the amount of "), _c('span', {
    staticClass: "strong"
  }, [_vm._v("$" + _vm._s(_vm.donation.total / 100))]), _vm._v(".\n            ")])]) : _c('div', [_c('p', [_vm._v("You're gift is a one-time gift in the amount of "), _c('span', {
    staticClass: "strong"
  }, [_vm._v("$" + _vm._s(_vm.donation.total / 100))]), _vm._v(".\n            ")])]), _vm._v(" "), _c('p', [_vm._v("Your name is "), _c('span', {
    staticClass: "strong"
  }, [_vm._v(_vm._s(_vm.fullName))]), _vm._v(" and your live at "), _c('span', {
    staticClass: "strong"
  }, [_vm._v(_vm._s(_vm.address))]), _vm._v(".\n            As a side note, we will use that address to mail your donation receipts.")]), _vm._v(" "), _c('p', [_vm._v("If everything above looks good, click the give button below and let's partner together to transform a\n            city!")]), _vm._v(" "), _c('button', {
    staticClass: "button is-primary is-large",
    class: [_vm.isProcessing ? 'is-loading' : ''],
    attrs: {
      "id": "submitFormButton",
      "type": "button"
    },
  ...
  }, [_vm._m(0)]), _vm._v(" "), (this.donation.error) ? _c('div', {
    staticClass: "notification is-danger error-notification"
  }, [_vm._v("\n            " + _vm._s(this.donation.error) + "\n        ")]) : _vm._e()])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-54beee15", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "has-text-centered title is-4"
  }, [_vm._v("Personal Info")]), _vm._v(" "), _c('label', {
    staticClass: "label"
  }, [_vm._v("How would you like to designate this gift?")]), _vm._v(" "), _c('p', {
    staticClass: "control"
  }, [_c('span', {
    staticClass: "select"
  }, [_c('select', {
  ...
  }, [_vm._v(_vm._s(_vm.errors.first('firstName')))])]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "validate",
    ...
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('lastName')))])])]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "validate",
    ...
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('email')))])]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "validate",
    ...
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('zip')))])]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "mask",
  ...
  })])]), _vm._v(" "), (_vm.donation.designation == '4') ? _c('p', {
    staticClass: "control"
  }, [_c('textarea', {
    directives: [{
      name: "validate",
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('staffSupport')),
      expression: "errors.has('staffSupport')"
    }],
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('staffSupport')))])]) : _vm._e(), _vm._v(" "), (_vm.donation.designation == '5') ? _c('p', {
    staticClass: "control"
  }, [_c('textarea', {
    directives: [{
      name: "validate",
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('missionSupport')),
      expression: "errors.has('missionSupport')"
    }],
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('missionSupport')))])]) : _vm._e(), _vm._v(" "), _c('button', {
    staticClass: "button is-light recurring-button",
    class: [_vm.donation.recurring ? 'active' : ''],
    attrs: {
      "type": "button"
    },
    on: {
      "click": _vm.toggleRecurring
    }
  }, [(_vm.donation.recurring === false) ? _c('span', [_c('i', {
    staticClass: "fa fa-heart"
  }), _vm._v(" Make this gift recurring?")]) : _vm._e(), _vm._v(" "), (_vm.donation.recurring) ? _c('span', [_c('i', {
    staticClass: "fa fa-heart"
  }), _vm._v(" This gift will be recurring!")]) : _vm._e()])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('h1', {
    staticClass: "has-text-centered is-1"
  }, [_c('i', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-571d4f4c", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "button is-large is-dark",
    class: [_vm.isValid ? '' : 'is-disabled'],
    attrs: {
      "id": "next-button",
      "type": "button"
    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-66c886ea", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "has-text-centered title is-4"
  }, [_vm._v("Credit Card Info")]), _vm._v(" "), _c('p', {
    staticClass: "has-text-centered"
  }, [_vm._v("Please fill out all of the credit card information below.")]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "validate",
    ...
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('nameOnCard')))])]), _vm._v(" "), _c('p', {
    staticClass: "control is-expanded"
  }, [_c('input', {
    directives: [{
      name: "validate",
    ...
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('cvc')))])]), _vm._v(" "), _c('p', {
    staticClass: "control exp"
  }, [_c('span', {
    staticClass: "select"
  }, [_c('select', {
    directives: [{
    ...
    on: {
      "change": _vm.updateCreditCard
    }
  }, [_c('option', {
    attrs: {
      "value": ""
    }
  }, [_vm._v("Exp Month")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "1"
    }
  ...
  }, [_vm._v("December")])])]), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('exp_month')),
      expression: "errors.has('exp_month')"
    }],
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('exp_month')))])]), _vm._v(" "), _c('p', {
    staticClass: "control exp"
  }, [_c('span', {
    staticClass: "select"
  }, [_c('select', {
  ...
  }, [_vm._v("Exp Year")]), _vm._v(" "), _vm._l((_vm.years), function(year) {
    return _c('option', [_vm._v(_vm._s(year))])
  })], 2)]), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('exp_year')),
      expression: "errors.has('exp_year')"
    }],
    staticClass: "help is-danger"
  }, [_vm._v(_vm._s(_vm.errors.first('exp_year')))])])])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('h1', {
    staticClass: "has-text-centered is-1"
  }, [_c('i', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-72760474", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "has-text-centered title is-4"
  }, [_vm._v("Thank you, " + _vm._s(_vm.name) + ".")]), _vm._v(" "), _c('p', [_vm._v("We can't thank you enough for partnering with us to help in transforming cities. Please continue to pray\n            for us as we work diligently to reach our goal of Taking the City.")]), _vm._v(" "), _c('h5', {
    staticClass: "has-text-centered title is-5"
  }, [_vm._v("Your gift was received!")]), _vm._v(" "), _c('img', {
    ...
    staticClass: "button visit-site",
    attrs: {
      "href": "http://takethecity.com"
    }
  }, [_vm._v("Visit our site!")])])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7ad15cb2", module.exports)
  }
}
...
var update = __webpack_require__(3)("4caa113b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0ebe54bf!../../../../../node_modules/stylus-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./donation-form.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0ebe54bf!../../../../../node_modules/stylus-loader/index.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./donation-form.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("23b9b672", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3f6cc516!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./amount-info.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3f6cc516!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./amount-info.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("66d26561", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-54beee15!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./review.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-54beee15!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./review.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("0b15c332", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-571d4f4c!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./peronsal-info.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-571d4f4c!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./peronsal-info.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("4a43470a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-66c886ea!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./nav-buttons.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-66c886ea!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./nav-buttons.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7bf78957", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-72760474!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./credit-card-info.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-72760474!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./credit-card-info.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("0a26a233", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7ad15cb2!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./confirmation.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-7ad15cb2!../../../../../../node_modules/stylus-loader/index.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./confirmation.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
